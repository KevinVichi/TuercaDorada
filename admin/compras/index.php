...
<main class="flex-shrink-0">
  <div class="container mt-3">
    <div class="text-end">
      <a href="genera_reporte_compras.php" class="btn btn-secondary">
        Reporte
      </a>
    </div>
    <br>
      ...
      <tbody>
        <?php while ($row = $resultado->fetch(PDO::FETCH_ASSOC)) { ?>
          <tr>
            ...
            <td>
              <button type="button" class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#detalleModal"
                ata-bs-orden="<?php echo $row['id_transaccion']; ?>">
