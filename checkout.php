            ...
            ?>
                <tr>
                  ...
                  <td><a href="#" id="eliminar" class="btn btn-danger btn-sm" data-bs-id="<?php echo $_id; ?>"
                      data-bs-toggle="modal" data-bs-target="#eliminaModal"><img src="../Ecommerce//icons//delete.svg"
                        alt=""></a></td>
                </tr>
              <?php } ?>
              <tr>
        ...
        <div class="row">
          <div class="col-md-5 offset-md-7 d-grid gap-2">
            <?php if (isset($_SESSION['user_cliente'])) { ?>
              <a href="pago.php" class="btn btn-secondary btn-lg">Realizar Pago</a>
            <?php } else { ?>
              <a href="login.php?pago" class="btn btn-secondary btn-lg">Realizar Pago</a>
            <?php } ?>
          </div>
        </div>
      <?php } ?>
